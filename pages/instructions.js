            ...
            <List>
              ...
              <ListItem>
                <Typography variant="body2">
                  ...
                  matching or resolving, then set "Processing Mode" to "Perform
                  Name Resolution". For "Family Classification", option
                  ...
                  classification; however, this may change in the future. By
                  default, setting "Sources" includes all available taxonomic
                  sources. However, some users may prefer or be required to use
                  only a single taxonomic source. For example, government users
                  in the U.S.A. may be required to resolve species names using
                  USDA Plants taxonomy only (source "USDA").
                </Typography>
              </ListItem>
              <ListItem>
                <Typography variant="body2">
              ...
              <ListItem>
                <Typography variant="body2">
                  6. <strong>Download data</strong>. After you have inspected
                  your results and made changes, if any, you can download your
              ...
              <ListItem>
                <Typography variant="body2">
                  ...
                  settings" button to download a summary of the settings,
                  source, & application versions used to process your names. We
                  recommend you include this information in your publication, as
                  the same names processed using different settings, versions or
                  sources may be resolved differently. Reporting this
                  information is important for repeatability of research
                  results.
                </Typography>
              </ListItem>
              <ListItem>
                <Typography variant="body2">
                  8. <strong>Cite your sources</strong>. Please cite the TNRS
                  and all taxonomic sources used in any publication which
                  includes taxonomic names resolved using the TNRS. See{" "}
